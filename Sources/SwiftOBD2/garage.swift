    ...
    func loadMockGarage() {
        let mockVehicle1 = Vehicle(id: 0,
                                   ...
                                   obdinfo: OBDInfo(vin: "1234567890",
                                                    ...
                                                    obdProtocol: .ISO_15765_4_11bit_500k, ecuMap: [0x01: .engine, 0x02: .transmission]))

        let mockVehicle2 = Vehicle(id: 1, make: "Mock-Toyota", model: "Camry", year: "2019", obdinfo: OBDInfo(obdProtocol: PROTOCOL.ISO_15765_4_11bit_500k))
